...
import com.tenko.myst.ui.screen.AddMedicineTest
...
fun AppNavigation() {
    ...
    val screensWithBottomBar = listOf(
        ...
        AppScreens.DoctorsScreen.route,
        AppScreens.CalendarScreen.route
    )
...
//        composable("confirm") { ConfirmScreen(navController, formStateViewModel) }
